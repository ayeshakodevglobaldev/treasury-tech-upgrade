import { ApexLegend, ApexStroke, ApexXAxis, ChartType } from "ng-apexcharts";
...
export const ApexRandomData :Randomchart = {
    series: [{
        data: [
            [1327359600000, 30.95],
            [1327446000000, 31.34],
...
export const ApexChartData : Areachart= {
    series: [{
        name: 'series1',
...
export const StackedBarData :BarChart1 = {
    series: [{
        name: 'Marine Sprite',
...
export const DonutChartData:ApexChart = {
    pieseries: [23, 16, 10, 15],
...
export const RadialBarCircleData:RadialChart = {
    pieseries: [70],
    chart: {
        height: 300,
        type: 'radialBar',
